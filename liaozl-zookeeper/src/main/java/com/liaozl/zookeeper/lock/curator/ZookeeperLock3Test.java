            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        ZookeeperLock3 zkLock = new ZookeeperLock3(client, lockPath);

                        for (int j = 0; j < 3; ++j) {
                            zkLock.readLock(60, TimeUnit.SECONDS, new ZookeeperLockCallBack() {
                                @Override
                                public void doLock() {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        for (int j = 0; j < 3; ++j) {
                            zkLock.writeLock(60, TimeUnit.SECONDS, new ZookeeperLockCallBack() {
                                @Override
                                public void doLock() {
                                    System.out.println(Thread.currentThread().getId() + " Get the lock");
                                    try {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        for (int j = 0; j < 3; ++j) {
                            zkLock.lock(60, TimeUnit.SECONDS, new ZookeeperLockCallBack() {
                                @Override
                                public void doLock() {
                                    System.out.println(Thread.currentThread().getId() + " Get the lock");
                                    try {
